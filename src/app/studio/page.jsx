    ...
    <div className="studio">
      ...
      <section className="studio-header">
        <div className="studio-header-copy">
          <h2>
            At OH Architecture, we take a collaborative approach. Whether we’re
            working in the studio or alongside our clients and partnerws, it’s
            this shared process that helps us create work that reflects your
            vision and ours.
          </h2>
        </div>
      </section>
